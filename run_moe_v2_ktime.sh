#!/usr/bin/env bash
# Measure achieved bandwidth of the on-device fp8 MoE kernels (SKEIN_MOE_KTIME).
...
# INVALID — only the "SKEIN_MOE_KTIME ... GB/s" lines are meaningful.
set -u
